...
EdgeInsetsGeometry? getMargin(String className) {
  switch (className) {
    ...
    case 'm-auto': return const EdgeInsets.all(double.infinity);
    case 'mx-auto': return const EdgeInsets.symmetric(horizontal: double.infinity);
    case 'my-auto': return const EdgeInsets.symmetric(vertical: double.infinity);
    case 'ms-auto': return const EdgeInsetsDirectional.only(start: double.infinity);
    case 'me-auto': return const EdgeInsetsDirectional.only(end: double.infinity);
    case 'mt-auto': return const EdgeInsets.only(top: double.infinity);
    case 'mr-auto': return const EdgeInsets.only(right: double.infinity);
    case 'mb-auto': return const EdgeInsets.only(bottom: double.infinity);
    case 'ml-auto': return const EdgeInsets.only(left: double.infinity);
...
EdgeInsetsGeometry? getPadding(String tailwindPadding) {
  switch (tailwindPadding) {
    ...
    default: return const EdgeInsets.all(0); // Default jika kode tidak cocok
  }
}
...
Color? getTextColor(String className) {
  switch (className) {
    //INHERIT
    case 'text-inherit': return TailwindColors.inherit;
    case 'text-current': return TailwindColors.currentColor;
    case 'text-transparent': return TailwindColors.transparent;
    case 'text-black': return TailwindColors.black;
    case 'text-white': return TailwindColors.white;
    case 'text-slate-50': return TailwindColors.slate50;
    case 'text-slate-100': return TailwindColors.slate100;
    case 'text-slate-200': return TailwindColors.slate200;
    case 'text-slate-300': return TailwindColors.slate300;
    case 'text-slate-400': return TailwindColors.slate400;
    case 'text-slate-500': return TailwindColors.slate500;
    case 'text-slate-600': return TailwindColors.slate600;
    case 'text-slate-700': return TailwindColors.slate700;
    case 'text-slate-800': return TailwindColors.slate800;
    case 'text-slate-900': return TailwindColors.slate900;
    case 'text-slate-950': return TailwindColors.slate950;
    // GRAY
    case 'text-gray-50': return TailwindColors.gray50;
    case 'text-gray-100': return TailwindColors.gray100;
    case 'text-gray-200': return TailwindColors.gray200;
    case 'text-gray-300': return TailwindColors.gray300;
    case 'text-gray-400': return TailwindColors.gray400;
    case 'text-gray-500': return TailwindColors.gray500;
    case 'text-gray-600': return TailwindColors.gray600;
    case 'text-gray-700': return TailwindColors.gray700;
    case 'text-gray-800': return TailwindColors.gray800;
    case 'text-gray-900': return TailwindColors.gray900;
    case 'text-gray-950': return TailwindColors.gray950;
    //RED
    case 'text-red-50': return TailwindColors.red50;
    case 'text-red-100': return TailwindColors.red100;
    case 'text-red-200': return TailwindColors.red200;
    case 'text-red-300': return TailwindColors.red300;
    case 'text-red-400': return TailwindColors.red400;
    case 'text-red-500': return TailwindColors.red500;
    case 'text-red-600': return TailwindColors.red600;
    case 'text-red-700': return TailwindColors.red700;
    case 'text-red-800': return TailwindColors.red800;
    case 'text-red-900': return TailwindColors.red900;
    case 'text-red-950': return TailwindColors.red950;
    //ZINC
    case 'text-zinc-50': return TailwindColors.zinc50;
    case 'text-zinc-100': return TailwindColors.zinc100;
    case 'text-zinc-200': return TailwindColors.zinc200;
    case 'text-zinc-300': return TailwindColors.zinc300;
    case 'text-zinc-400': return TailwindColors.zinc400;
    case 'text-zinc-500': return TailwindColors.zinc500;
    case 'text-zinc-600': return TailwindColors.zinc600;
    case 'text-zinc-700': return TailwindColors.zinc700;
    case 'text-zinc-800': return TailwindColors.zinc800;
    case 'text-zinc-900': return TailwindColors.zinc900;
    case 'text-zinc-950': return TailwindColors.zinc950;
    //Neutral
    case 'text-neutral-50': return TailwindColors.neutral50;
    case 'text-neutral-100': return TailwindColors.neutral100;
    case 'text-neutral-200': return TailwindColors.neutral200;
    case 'text-neutral-300': return TailwindColors.neutral300;
    case 'text-neutral-400': return TailwindColors.neutral400;
    case 'text-neutral-500': return TailwindColors.neutral500;
    case 'text-neutral-600': return TailwindColors.neutral600;
    case 'text-neutral-700': return TailwindColors.neutral700;
    case 'text-neutral-800': return TailwindColors.neutral800;
    case 'text-neutral-900': return TailwindColors.neutral900;
    case 'text-neutral-950': return TailwindColors.neutral950;

    //STONE
    case 'text-stone-50': return TailwindColors.stone50;
    case 'text-stone-100': return TailwindColors.stone100;
    case 'text-stone-200': return TailwindColors.stone200;
    case 'text-stone-300': return TailwindColors.stone300;
    case 'text-stone-400': return TailwindColors.stone400;
    case 'text-stone-500': return TailwindColors.stone500;
    case 'text-stone-600': return TailwindColors.stone600;
    case 'text-stone-700': return TailwindColors.stone700;
    case 'text-stone-800': return TailwindColors.stone800;
    case 'text-stone-900': return TailwindColors.stone900;
    case 'text-stone-950': return TailwindColors.stone950;
    
    //ORANGE
    case 'text-orange-50': return TailwindColors.orange50;
    case 'text-orange-100': return TailwindColors.orange100;
    case 'text-orange-200': return TailwindColors.orange200;
    case 'text-orange-300': return TailwindColors.orange300;
    case 'text-orange-400': return TailwindColors.orange400;
    case 'text-orange-500': return TailwindColors.orange500;
    case 'text-orange-600': return TailwindColors.orange600;
    case 'text-orange-700': return TailwindColors.orange700;
    case 'text-orange-800': return TailwindColors.orange800;
    case 'text-orange-900': return TailwindColors.orange900;
    case 'text-orange-950': return TailwindColors.orange950;
    
    //AMBER
    case 'text-amber-50': return TailwindColors.amber50;
    case 'text-amber-100': return TailwindColors.amber100;
    case 'text-amber-200': return TailwindColors.amber200;
    case 'text-amber-300': return TailwindColors.amber300;
    case 'text-amber-400': return TailwindColors.amber400;
    case 'text-amber-500': return TailwindColors.amber500;
    case 'text-amber-600': return TailwindColors.amber600;
    case 'text-amber-700': return TailwindColors.amber700;
    case 'text-amber-800': return TailwindColors.amber800;
    case 'text-amber-900': return TailwindColors.amber900;
    case 'text-amber-950': return TailwindColors.amber950;

    //YELLOW
    case 'text-yellow-50': return TailwindColors.yellow50;
    case 'text-yellow-100': return TailwindColors.yellow100;
    case 'text-yellow-200': return TailwindColors.yellow200;
    case 'text-yellow-300': return TailwindColors.yellow300;
    case 'text-yellow-400': return TailwindColors.yellow400;
    case 'text-yellow-500': return TailwindColors.yellow500;
    case 'text-yellow-600': return TailwindColors.yellow600;
    case 'text-yellow-700': return TailwindColors.yellow700;
    case 'text-yellow-800': return TailwindColors.yellow800;
    case 'text-yellow-900': return TailwindColors.yellow900;
    case 'text-yellow-950': return TailwindColors.yellow950;
    
    //LIME
    case 'text-lime-50': return TailwindColors.lime50;
    case 'text-lime-100': return TailwindColors.lime100;
    case 'text-lime-200': return TailwindColors.lime200;
    case 'text-lime-300': return TailwindColors.lime300;
    case 'text-lime-400': return TailwindColors.lime400;
    case 'text-lime-500': return TailwindColors.lime500;
    case 'text-lime-600': return TailwindColors.lime600;
    case 'text-lime-700': return TailwindColors.lime700;
    case 'text-lime-800': return TailwindColors.lime800;
    case 'text-lime-900': return TailwindColors.lime900;
    case 'text-lime-950': return TailwindColors.lime950;

    //GREEN
    case 'text-green-50': return TailwindColors.green50;
    case 'text-green-100': return TailwindColors.green100;
    case 'text-green-200': return TailwindColors.green200;
    case 'text-green-300': return TailwindColors.green300;
    case 'text-green-400': return TailwindColors.green400;
    case 'text-green-500': return TailwindColors.green500;
    case 'text-green-600': return TailwindColors.green600;
    case 'text-green-700': return TailwindColors.green700;
    case 'text-green-800': return TailwindColors.green800;
    case 'text-green-900': return TailwindColors.green900;
    case 'text-green-950': return TailwindColors.green950;
    
    //EMERALD
    case 'text-emerald-50': return TailwindColors.emerald50;
    case 'text-emerald-100': return TailwindColors.emerald100;
    case 'text-emerald-200': return TailwindColors.emerald200;
    case 'text-emerald-300': return TailwindColors.emerald300;
    case 'text-emerald-400': return TailwindColors.emerald400;
    case 'text-emerald-500': return TailwindColors.emerald500;
    case 'text-emerald-600': return TailwindColors.emerald600;
    case 'text-emerald-700': return TailwindColors.emerald700;
    case 'text-emerald-800': return TailwindColors.emerald800;
    case 'text-emerald-900': return TailwindColors.emerald900;
    case 'text-emerald-950': return TailwindColors.emerald950;

    //TEAL
    case 'text-teal-50': return TailwindColors.teal50;
    case 'text-teal-100': return TailwindColors.teal100;
    case 'text-teal-200': return TailwindColors.teal200;
    case 'text-teal-300': return TailwindColors.teal300;
    case 'text-teal-400': return TailwindColors.teal400;
    case 'text-teal-500': return TailwindColors.teal500;
    case 'text-teal-600': return TailwindColors.teal600;
    case 'text-teal-700': return TailwindColors.teal700;
    case 'text-teal-800': return TailwindColors.teal800;
    case 'text-teal-900': return TailwindColors.teal900;
    case 'text-teal-950': return TailwindColors.teal950;
    
    //CYAN
    case 'text-cyan-50': return TailwindColors.cyan50;
    case 'text-cyan-100': return TailwindColors.cyan100;
    case 'text-cyan-200': return TailwindColors.cyan200;
    case 'text-cyan-300': return TailwindColors.cyan300;
    case 'text-cyan-400': return TailwindColors.cyan400;
    case 'text-cyan-500': return TailwindColors.cyan500;
    case 'text-cyan-600': return TailwindColors.cyan600;
    case 'text-cyan-700': return TailwindColors.cyan700;
    case 'text-cyan-800': return TailwindColors.cyan800;
    case 'text-cyan-900': return TailwindColors.cyan900;
    case 'text-cyan-950': return TailwindColors.cyan950;
    
    //SKY
    case 'text-sky-50': return TailwindColors.sky50;
    case 'text-sky-100': return TailwindColors.sky100;
    case 'text-sky-200': return TailwindColors.sky200;
    case 'text-sky-300': return TailwindColors.sky300;
    case 'text-sky-400': return TailwindColors.sky400;
    case 'text-sky-500': return TailwindColors.sky500;
    case 'text-sky-600': return TailwindColors.sky600;
    case 'text-sky-700': return TailwindColors.sky700;
    case 'text-sky-800': return TailwindColors.sky800;
    case 'text-sky-900': return TailwindColors.sky900;
    case 'text-sky-950': return TailwindColors.sky950;

    //BLUE
    case 'text-blue-50': return TailwindColors.blue50;
    case 'text-blue-100': return TailwindColors.blue100;
    case 'text-blue-200': return TailwindColors.blue200;
    case 'text-blue-300': return TailwindColors.blue300;
    case 'text-blue-400': return TailwindColors.blue400;
    case 'text-blue-500': return TailwindColors.blue500;
    case 'text-blue-600': return TailwindColors.blue600;
    case 'text-blue-700': return TailwindColors.blue700;
    case 'text-blue-800': return TailwindColors.blue800;
    case 'text-blue-900': return TailwindColors.blue900;
    case 'text-blue-950': return TailwindColors.blue950;

    //INDIGO
    case 'text-indigo-50': return TailwindColors.indigo50;
    case 'text-indigo-100': return TailwindColors.indigo100;
    case 'text-indigo-200': return TailwindColors.indigo200;
    case 'text-indigo-300': return TailwindColors.indigo300;
    case 'text-indigo-400': return TailwindColors.indigo400;
    case 'text-indigo-500': return TailwindColors.indigo500;
    case 'text-indigo-600': return TailwindColors.indigo600;
    case 'text-indigo-700': return TailwindColors.indigo700;
    case 'text-indigo-800': return TailwindColors.indigo800;
    case 'text-indigo-900': return TailwindColors.indigo900;
    case 'text-indigo-950': return TailwindColors.indigo950;
    
    //VIOLET
    case 'text-violet-50': return TailwindColors.violet50;
    case 'text-violet-100': return TailwindColors.violet100;
    case 'text-violet-200': return TailwindColors.violet200;
    case 'text-violet-300': return TailwindColors.violet300;
    case 'text-violet-400': return TailwindColors.violet400;
    case 'text-violet-500': return TailwindColors.violet500;
    case 'text-violet-600': return TailwindColors.violet600;
    case 'text-violet-700': return TailwindColors.violet700;
    case 'text-violet-800': return TailwindColors.violet800;
    case 'text-violet-900': return TailwindColors.violet900;
    case 'text-violet-950': return TailwindColors.violet950;

    //PURPLE
    case 'text-purple-50': return TailwindColors.purple50;
    case 'text-purple-100': return TailwindColors.purple100;
    case 'text-purple-200': return TailwindColors.purple200;
    case 'text-purple-300': return TailwindColors.purple300;
    case 'text-purple-400': return TailwindColors.purple400;
    case 'text-purple-500': return TailwindColors.purple500;
    case 'text-purple-600': return TailwindColors.purple600;
    case 'text-purple-700': return TailwindColors.purple700;
    case 'text-purple-800': return TailwindColors.purple800;
    case 'text-purple-900': return TailwindColors.purple900;
    case 'text-purple-950': return TailwindColors.purple950;

    //FUCHSIA
    case 'text-fuchsia-50': return TailwindColors.fuchsia50;
    case 'text-fuchsia-100': return TailwindColors.fuchsia100;
    case 'text-fuchsia-200': return TailwindColors.fuchsia200;
    case 'text-fuchsia-300': return TailwindColors.fuchsia300;
    case 'text-fuchsia-400': return TailwindColors.fuchsia400;
    case 'text-fuchsia-500': return TailwindColors.fuchsia500;
    case 'text-fuchsia-600': return TailwindColors.fuchsia600;
    case 'text-fuchsia-700': return TailwindColors.fuchsia700;
    case 'text-fuchsia-800': return TailwindColors.fuchsia800;
    case 'text-fuchsia-900': return TailwindColors.fuchsia900;
    case 'text-fuchsia-950': return TailwindColors.fuchsia950;
    //PINK
    case 'text-pink-50': return TailwindColors.pink50;
    case 'text-pink-100': return TailwindColors.pink100;
    case 'text-pink-200': return TailwindColors.pink200;
    case 'text-pink-300': return TailwindColors.pink300;
    case 'text-pink-400': return TailwindColors.pink400;
    case 'text-pink-500': return TailwindColors.pink500;
    case 'text-pink-600': return TailwindColors.pink600;
    case 'text-pink-700': return TailwindColors.pink700;
    case 'text-pink-800': return TailwindColors.pink800;
    case 'text-pink-900': return TailwindColors.pink900;
    case 'text-pink-950': return TailwindColors.pink950;

    //ROSE
    case 'text-rose-50': return TailwindColors.rose50;
    case 'text-rose-100': return TailwindColors.rose100;
    case 'text-rose-200': return TailwindColors.rose200;
    case 'text-rose-300': return TailwindColors.rose300;
    case 'text-rose-400': return TailwindColors.rose400;
    case 'text-rose-500': return TailwindColors.rose500;
    case 'text-rose-600': return TailwindColors.rose600;
    case 'text-rose-700': return TailwindColors.rose700;
    case 'text-rose-800': return TailwindColors.rose800;
    case 'text-rose-900': return TailwindColors.rose900;
    case 'text-rose-950': return TailwindColors.rose950;
